class Chess():
    ...
    def possibleMoves(self, pos):
        ...
        color = piece["color"]
        if piece["value"] == self.pieces["castle-white"] or piece["value"] == self.pieces["castle-black"]:
            return self.castleMoves(startPos_x, startPos_y, color)
        elif piece["value"] == self.pieces["knight-white"] or piece["value"] == self.pieces["knight-black"]:
            return self.knightMoves(startPos_x, startPos_y, color)
        elif piece["value"] == self.pieces["bishop-white"]  or piece["value"] == self.pieces["bishop-black"]:
            return self.bishopMoves(startPos_x, startPos_y, color)
        elif piece["value"] == self.pieces["queen-white"] or piece["value"] == self.pieces["queen-black"]:
            return [*self.castleMoves(startPos_x, startPos_y, color), *self.bishopMoves(startPos_x, startPos_y, color)]
        elif piece["value"] == self.pieces["king-white"] or piece["value"] == self.pieces["king-black"]:
            return self.kingMoves(startPos_x, startPos_y, color)
        elif piece["value"] == self.pieces["pawn-white"] or piece["value"] == self.pieces["pawn-black"]:
            pass
